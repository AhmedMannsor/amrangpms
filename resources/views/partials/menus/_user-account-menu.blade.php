    ...
    <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
        ...
        <span class="menu-title position-relative">Language
            <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                {{ session('app_locale') == 'ar' ? 'Arabic' : 'English' }}
                <img class="w-15px h-15px rounded-1 ms-2" src="{{ image(session('app_locale') == 'ar' ? 'flags/yemen.svg' : 'flags/united-states.svg') }}" alt="" />
            </span>
        </span>
        </a>
        <div class="menu-sub menu-sub-dropdown w-175px py-4">
            <div class="menu-item px-3">
                <a href="{{ route('set.language', ['lang' => 'en']) }}" class="menu-link d-flex px-5 {{ session('app_locale') == 'en' ? 'active' : '' }}">
                <span class="symbol symbol-20px me-4">
                    <img class="rounded-1" src="{{ image('flags/united-states.svg') }}" alt=""/>
                </span>
                    English
            ...
            <div class="menu-item px-3">
                <a href="{{ route('set.language', ['lang' => 'ar']) }}" class="menu-link d-flex px-5 {{ session('app_locale') == 'ar' ? 'active' : '' }}">
                <span class="symbol symbol-20px me-4">
                    <img class="rounded-1" src="{{ image('flags/yemen.svg') }}" alt=""/>
                </span>
                    Arabic
                </a>
            </div>
